...
SELECT DISTINCT a1.USER_ID
	   --a1.PURCHASE_DATE AS FIRST_PURCHASE_DATE,
	   --a2.PURCHASE_DATE AS SECOND_PURCHASE_DATE,
	   --a2.PURCHASE_DATE - a1.PURCHASE_DATE AS DIFFERENCE
...
--The above query lists out the users who have made second purchase <=7 Days
...
--LISTED OUT THE USERS WHO HAVE MADE SECOND PURCHASE AFTER 7 DAYS
